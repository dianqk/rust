...
#[unsafe(no_mangle)]
fn local_var() {
    // CHECK-LABEL: define void @local_var
...
fn cast(aggregate_4xi8: Aggregate_4xi8) {
    // CHECK-LABEL: define void @cast(i32 %0)
    // CHECK: call void @opaque_fn()
    opaque_fn();
...
fn direct_ref_and_indirect(
    ...
    // CHECK-LABEL: define void @direct_ref_and_indirect
