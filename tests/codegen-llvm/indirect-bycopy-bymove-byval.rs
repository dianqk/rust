...
// CHECK-LABEL: @byval
// CHECK: call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[byval_V1:%.*]], ptr align 8 %value, i64 24, i1 false)
// CHECK: call void @opaque_byval(ptr{{.*}} byval([24 x i8]){{.*}} [[byval_V1]])
// CHECK: call void @opaque_byval(ptr{{.*}} byval([24 x i8]){{.*}} %value)
// CHECK: call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[byval_V3:%.*]], ptr align 8 @anon{{.*}}, i64 24, i1 false)
